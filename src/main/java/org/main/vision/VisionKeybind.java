...
public class VisionKeybind {
    ...
    static void register() {
        ...
        stepKey = new KeyBinding("key.vision.step", GLFW.GLFW_KEY_V, "key.categories.vision");
        reachKey = new KeyBinding("key.vision.reach", GLFW.GLFW_KEY_C, "key.categories.vision");
