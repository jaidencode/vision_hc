...
import org.main.vision.actions.LegacyPvpHack;
...
public class VisionClient {
    ...
    private static final LegacyPvpHack LEGACYPVP_HACK = new LegacyPvpHack();
    ...
    public static LegacyPvpHack getLegacyPvpHack() {
        return LEGACYPVP_HACK;
    }
    ...
    public static void onKeyInput(InputEvent.KeyInputEvent event) {
        ...
        if (event.getKey() == VisionKeybind.legacyPvpKey.getKey().getValue() && event.getAction() == GLFW.GLFW_PRESS && Minecraft.getInstance().screen == null) {
            LEGACYPVP_HACK.toggle();
        }
